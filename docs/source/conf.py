# -*- coding: utf-8 -*-
#
# Leabra Tensorflow documentation build configuration file, created by
# sphinx-quickstart.
#
...
import leabratf
version = leabratf.__version__
# The full version, including alpha/beta/rc tags.
release = leabratf.__version__
...
latex_documents = [
    ('index',
     'leabra-tf.tex',
     u'Leabra Tensorflow Documentation',
     u"apra93", 'manual'),
]
...
man_pages = [
    ('index', 'leabra-tf', u'Leabra Tensorflow Documentation',
     [u"apra93"], 1)
]
